...
A suppler can serve all the clients $i\in\mcM$ from location $l$ if the service cost $c(l,i)$ is the least and offer a price which is the second cheapest.\pause
