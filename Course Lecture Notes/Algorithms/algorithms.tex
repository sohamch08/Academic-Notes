...
\usepackage{xhfill}
\definecolor{mychaptercolor}{HTML}{2E3192}

\usetikzlibrary{calc} 

\titleformat{\chapter}[display]
{}
{\hfill \tikz[remember picture] \node[] (nr) {\fontsize{20}{70}\selectfont\color{mychaptercolor}\textsc{Chapter~~} \fontsize{60}{70}\selectfont\color{mychaptercolor}\thechapter};
