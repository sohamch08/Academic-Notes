...
\usepackage{amsmath,amsfonts,amsthm,amssymb,mathtools,titlesec}
\usepackage{bookmark}
\usepackage[inline]{enumitem}
\usepackage{hyperref,theoremref,changepage}
\hypersetup{
...
\fancyhead[LE]{\itshape\textsc{\nouppercase\rightmark}}% Left even page header
\fancyhead[RO]{\itshape\textsc{\nouppercase\leftmark}}% Right odd page header
\fancyfoot{}% Clear footer
\fancyhead[RE,LO]{\itshape Page \thepage}% Even page right and odd page left headers
...
\definecolor{mytoccolor}{HTML}{A11717}
...
%================================
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[use counter from=Theorem, number within=subsection]{corolary}{Corollary}
{%
	enhanced
	,breakable
	,colback = myp!10
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[use counter from=Theorem, number within=subsection]{claim}{Claim}
{%
	enhanced
	,breakable
	,colback = myg!10
...
\newtcbtheorem[number within=subsection]{open}{Open Question}{enhanced,
...
\makeatletter
\newtcbtheorem[number within=subsection]{problem}{Problem}{enhanced,
	breakable,
	colback=white,
...
\newenvironment{proof-of-theorem}[1][]{\noindent{\textit{\textbf{Proof of \thmref{#1}:}}}\hspace*{1em}}{\hfill\qed\bigskip\\}
\newenvironment{proof-of-lemma}[1][]{\noindent{\textit{\textbf{Proof of  \lmref{#1}:}}}\hspace*{1em}}{\hfill\qed\bigskip\\}
...
\newenvironment{alternate-proof}[1][]{\noindent{\textit{\textbf{Alternate Proof \thmref{#1}:}}}\hspace*{1em}}{\hfill\qed\bigskip\\}
...
{\addvspace{30pt}%
	\begin{tikzpicture}[remember picture, overlay]%
		...
		\pgftext[left,x=-3.3cm,y=0.17cm]{\color{white}\Large\sc\bfseries Section\ \thecontentslabel};%
