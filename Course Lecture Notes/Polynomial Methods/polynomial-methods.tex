...
\definecolor{mycolor1}{HTML}{D1603D}
\definecolor{mycolor2}{HTML}{210D08}
%\usepackage{anysize}
...
\input{sections/all-pairs-shortest-path}
\input{sections/matrix-rigidity}
