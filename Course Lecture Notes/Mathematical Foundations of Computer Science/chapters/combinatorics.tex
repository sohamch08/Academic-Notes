...
\end{Theorem}
\begin{proof}
	First of all take all the subsets of $\{0,1\}^n$ of size $\lt\lceil\frac{n}2\rt\rceil$ and this number is $\binom{n}{\lt\lceil\frac{n}2\rt\rceil}$. These sets form an anti-chain. Therefore we have $w(\mcB_n)\geq \binom{n}{\lt\lceil\frac{n}2\rt\rceil}$.
