...
\begin{Example}{Fano System}{}
	For $n=7$ consider the following sets \begin{align*}
		S_1=\{1,3,2\}, && &S_2=\{2,6,4\}, && S_3=\{4,5,1\},\\ 
		S_4=\{1,7,6\}, && &S_5=\{2,7,5\}, && S_6=\{4,7,3\},\\ 
		&& &S_7=\{3,5,6\} &&  
	\end{align*}This forms a projective plane as it follows all the conditions. This projective plane is represented like this:
\end{Example}
\begin{Theorem}{}{}
