...
\newcommand{\handout}[3]{
	...
	\begin{center}
		\framebox{
			\vbox{
				\hbox to 6.5in { {\bf Combinatorial Optimization } \hfill Jan -- May, 2025 }
				\vspace{4mm}
...
\newenvironment{claimwidth}{\begin{center}\begin{adjustwidth}{0.03\textwidth}{0.03\textwidth}}{\end{adjustwidth}\end{center}}