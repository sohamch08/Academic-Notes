...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\setcounter{page}{1}
\input{chapters/equilibriums}
\input{chapters/bimatrix-game}
\input{chapters/complexity-class}
\input{chapters/dynamics-regrets}
\input{chapters/potential-game}
\input{chapters/equilibria-efficiency}
\input{chapters/smooth-games}
\input{chapters/mechanishm-design}
