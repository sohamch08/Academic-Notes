...
\end{problem}
\solve{
	We will solve this algorithm for any $n\times m$ block where $f:[n]\times [m]\to [n]\times [m]$ with the properties same as given in the question.
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Problem 5
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{enumerate}[label=(\alph*)]
	...
	\begin{algorithm}
		...
		\Begin{
		$T\longleftarrow S_1\cup S_2$ sorted by $x-$coordinate\;
		\For{$i=1,\dots, 2n$}{
	$U\longleftarrow $ Next 64 points in $T$\;
	\For{$\hat{P}\in U$}{
