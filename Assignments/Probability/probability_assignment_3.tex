...
If $X_1,X_2$ is jointly Gaussian then the marginal distribution on $X_2$ is also Gaussian. Since we know the marginal distribution on $X_2$ is not Gaussian we have $X_1,X_2$ are not joinly Gaussian. 
}
