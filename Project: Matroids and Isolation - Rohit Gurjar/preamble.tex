...
{%
	...
	,frame hidden
	,boxrule = 0sp
	,borderline west = {2pt}{0pt}{mytheorembfr}
	,sharp corners
	,detach title
	,before upper = \tcbtitle\par\smallskip
	,coltitle = mytheoremfr
...
\renewenvironment{proof-sketch}{\noindent{\bf Sketch of Proof:}\hspace*{1em}}{\hfill\qed\bigskip\\}
\renewenvironment{proof-idea}{\noindent{\bf Proof Idea:}\hspace*{1em}}{\hfill\qed\bigskip\\}
\renewenvironment{proof-of-lemma}[1]{\noindent{\bf Proof of Lemma #1:}\hspace*{1em}}{\hfill\qed\bigskip\\}
\renewenvironment{proof-of-claim}[1]{\noindent{\bf Proof of Claim #1:}\hspace*{1em}}{\hfill\qed\bigskip\\}
\renewenvironment{proof-attempt}{\noindent{\bf Proof Attempt:}\hspace*{1em}}{\hfill\qed\bigskip\\}
\renewenvironment{proofof}[1]{\noindent{\bf Proof:}
