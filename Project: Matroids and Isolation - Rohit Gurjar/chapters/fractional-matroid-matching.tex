...
First we will define some elements called alternating indicator vetors and alternating circuits following the \cite{generalmatchingola} for the proof of \thrmref{latticevector-polybounded}.
...
\begin{lemma}{\cite[Proof of Claim 1, Proof of Theorem 3.4]{gurjarfrac}}{altcircuit-in-lattice}
...
\begin{lemma}{\cite[Claim 1, Proof of Theorem 3.4]{gurjarfrac}}{latiice-vector-decomposition}
...
\begin{Theorem}{\cite[Lemma 5.4]{generalmatchingola}}{ola-altcircuitn17}
